  ...
  <UModal v-model:open="isOpen" :title="modalTitle">
    <template #body>
      <div class="space-y-4">
        ...
        <div
          v-if="successMessage"
          class="p-3 rounded-lg bg-green-50 border border-green-200 text-green-800 dark:bg-green-900 dark:border-green-700 dark:text-green-100"
        >
          {{ successMessage }}
        </div>
        ...
        <div
          v-if="errorMessage"
          class="p-3 rounded-lg bg-red-50 border border-red-200 text-red-800 dark:bg-red-900 dark:border-red-700 dark:text-red-100"
        >
          {{ errorMessage }}
        </div>
        ...
        <div class="grid gap-3">
          ...
          <UButton block icon="i-heroicons-arrow-down-tray" color="primary" @click="downloadAsJson">
...
const modalTitle = computed(() =>
  isMultipleExport.value ? t("sequences.exportAllModalTitle") : t("sequences.exportModalTitle"),
);
