<template>
  <div class="container mx-auto p-6 max-w-4xl">
    <!-- Header avec retour -->
    <div class="mb-6">
      <UButton to="/sequences" variant="ghost" icon="i-heroicons-arrow-left" class="mb-4">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div v-if="warmupSequences.length > 0" class="space-y-3 mb-4">
          <div
            ...
            :class="{
              'bg-blue-50 dark:bg-blue-900 border-blue-500': selectedWarmupId === warmup.id,
            }"
        ...
        <div class="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-600">
          <UButton variant="outline" class="flex-1" @click="startWorkout(false)">
